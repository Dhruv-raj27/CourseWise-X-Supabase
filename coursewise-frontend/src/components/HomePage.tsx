...
import { BookOpen, Users, Clock,  ArrowRight, Sparkles, GraduationCap, Target, Mail, Phone } from 'lucide-react';
...
export default function HomePage() {
  ...
  return (
    <div className="space-y-16 py-8">
      {/* Hero Section */}
      <section className={`relative bg-gradient-to-br from-indigo-600 to-purple-700 text-white py-24 rounded-3xl overflow-hidden transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        ...
        <div className="relative container mx-auto px-4 text-center">
          ...
          <button
            ...
            className="group bg-white text-indigo-600 hover:bg-indigo-50 px-8 py-4 rounded-lg text-lg font-semibold shadow-lg transition-all hover:scale-105"
          >
            Get Started
      ...
      {/* Add heading above the existing services grid */}
      ...
      {/* <section className="bg-gradient-to-r from-indigo-600 to-purple-600 py-16 rounded-3xl">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8 text-center text-white">
            <div className="group hover:scale-105 transition-transform">
              <div className="text-4xl font-bold mb-2 flex items-center justify-center">
                <span>1000</span>
                <Sparkles className="w-6 h-6 ml-1 animate-pulse" />
              </div>
              <div className="text-indigo-100">Available Courses</div>
            </div>
            <div className="group hover:scale-105 transition-transform">
              <div className="text-4xl font-bold mb-2 flex items-center justify-center">
                <span>50</span>
              ...
              <div className="text-indigo-100">Colleges accross India</div>
            </div>
            <div className="group hover:scale-105 transition-transform">
              <div className="text-4xl font-bold mb-2 flex items-center justify-center">
                <span>95</span>
      ...
      {/* Footer */}
      <footer className="bg-gradient-to-br from-indigo-600 to-purple-600 text-white">
        <div className="container mx-auto px-4 py-8">
          <div className="grid grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <div className="text-indigo-200">
                ...
                <div className="flex items-center gap-2 mb-1">
                  <span>1000+ Available Courses</span>
                </div>
                <div className="flex items-center gap-2 mb-1">
            ...
            <div>
              ...
              <div className="grid gap-2">
                ...
                <Link to="/courses" className="text-indigo-200 hover:text-white transition-colors">Courses</Link>
            ...
            <div>
              ...
              <div className="grid gap-2">
                <Link to="/courses/recommendations" className="text-indigo-200 hover:text-white transition-colors">
                  Course Recommendations
                </Link>
                <Link to="/courses/timetable" className="text-indigo-200 hover:text-white transition-colors">
                  Timetable Generator
                </Link>
                <Link to="/courses/reviews" className="text-indigo-200 hover:text-white transition-colors">
                  Course Reviews
                </Link>
              </div>
            </div>
          ...
          <div className="border-t border-indigo-500/30 mt-8 pt-8 text-center text-indigo-200">
            <p>© 2025 CourseWise. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
